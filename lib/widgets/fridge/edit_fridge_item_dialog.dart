...
class EditFridgeItemDialog extends StatefulWidget {
  final FridgeItemModel item;
  final FridgeModel fridge;
  const EditFridgeItemDialog({
    super.key,
    required this.item,
  ...
  @override
  State<EditFridgeItemDialog> createState() => _EditFridgeItemDialogState();
}

class _EditFridgeItemDialogState extends State<EditFridgeItemDialog> {
  ...
  void initState() {
    ...
    // Add legacy category if not present
  ...
  Future<void> _save() async {
    ...
    final result = await _fridgeItemService.updateFridgeItem(
      ...
      // expiryDate is not editable after creation, but you can add if needed
    );
